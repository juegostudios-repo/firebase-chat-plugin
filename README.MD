...
To create firebase setup follow the below steps:
    ...
    - To know and change the database security rules to your database, click [here](https://firebase.google.com/docs/database/security/quickstart) 

### Step One: Installation with ionic framework 3 (currently supported) 
```
...
### Step Two: Import the Statement in your Ionic project
```
import * as FirebaseChat  from 'juegostudio-firebase-chat-plugin';
```

### Step Three: Initialize your app
To initialize the app follow the below steps:
1. Go to your firebase account.
2. Click on "Add Firebase to your web app" Option. This will show the firebase connection details.
3. Copy the required credentials into your Ionic project.
...
### Step Four: Invoke following Methods in your Ionic project
