...
videoChatServerConfig is an `optional` parameter while creating the [instance](initialize-your-app) of `FirebaseChat`. URLs for STUN and TURN server can be set using this argument.
```
